...
echo ============================================
echo  Clipboard-Saver - Build (installer + portable)
echo ============================================
echo.
...
echo.
rem Full bundle: produces BOTH the portable exe (target\release\clipboard-saver.exe)
...
copy /y "%EXE%" "%DIST%\Clipboard-Saver.exe" >nul || echo [WARN] Could not update the portable exe in dist - is it currently running? Close it and rebuild.
...
echo ============================================
echo  DONE
echo  Portable : %DIST%\Clipboard-Saver.exe
